...
const GameLegend = (props) => {
  ...
  useEffect(() => {
    if (bobaFettFound) {
      ...
      document.getElementById("legend-boba").style.textDecoration =
        "line-through";
    }
    if (vaultBoyFound) {
      document.getElementById("legend-vault-boy").style.color = "red";
      document.getElementById("legend-vault-boy").style.textDecoration =
        "line-through";
    }
    if (samusFound) {
      document.getElementById("legend-samus").style.color = "red";
      document.getElementById("legend-samus").style.textDecoration =
        "line-through";
    }
    ...
    <div id="legend">
      ...
      <div id="legendWrapper" className="legend-hidden">
        <div id="legendList" className="legendList">
          ...
          <li id="legend-boba">Boba Fett</li>
          <br />
          <li>
            <span id="showHints">SHOW HINTS </span>{" "}
          </li>
          <li>
            <span id="hideHints">HIDE HINTS</span>
          </li>
        </div>
      </div>
